...
const dialogSwipeScss = 'dialog-swipe/dialog-swipe-example.component.scss';
...
export class DialogDocsComponent {
    ...
    swipeDialog: ExampleFile[] = [
        ...
        {
            language: 'scss',
            code: getAssetFromModuleAssets(dialogSwipeScss),
            fileName: 'dialog-swipe-example',
            component: 'DialogSwipeExample',
            scssFileCode: getAssetFromModuleAssets(dialogSwipeScss)
        }
    ];
